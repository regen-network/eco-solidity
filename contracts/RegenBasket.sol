 ...
 *
 * We follow general OpenZeppelin Contracts guidelines: functions revert
...
contract RegenBasket is IERC20, IERC20Metadata, Ownable {
     ...
     *
     * The default value of {decimals} is 18 (if 0 is set). To select a different value for
